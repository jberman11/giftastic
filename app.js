...
$("#add-animal").on("click", function (event) {
    ...
    $.ajax({
        url: "https://api.giphy.com/v1/gifs/search?&q=" + input + "&api_key=dc6zaTOxFJmzC&limit=10",
        method: "GET"
        ...
        for (i = 0; i < 10; i++) {
            ...
            var newGif = $("<img>")
            $("#animals-view").prepend(newGif).prepend($("<p>").addClass("asap").text("Rating: " + response.data[i].rating)).prepend("<br>")
